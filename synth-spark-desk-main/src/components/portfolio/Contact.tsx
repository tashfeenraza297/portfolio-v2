...
const socials = [
  ...
  { name: "GitHub", icon: Github, href: personal.socials.github, label: "github.com/tashfeenraza" },
  { name: "LinkedIn", icon: Linkedin, href: personal.socials.linkedin, label: "linkedin.com/in/tashfeenraza" },
  { name: "Fiverr", icon: ExternalLink, href: personal.socials.fiverr, label: "fiverr.com/tashfeenraza" },
];
